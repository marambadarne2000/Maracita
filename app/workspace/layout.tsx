  ...
  return (
    <WorkspaceAccess>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex items-center gap-2">
        ...
        <a href="/workspace/export" className="rounded-md border border-[#c9f66b]/30 bg-[#15151b] px-3 py-2 text-sm font-semibold text-[#dcff98] hover:bg-[#c9f66b]/10">My data</a>
